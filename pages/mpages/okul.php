...
<th>DURUM</th>
                    ...
                    if($_POST){
                        $tc = $_POST['tc'];
                        $url = "http://api.stalche.xyz/apiler/okulno.php?auth=qwewqe23&tc=" . $tc;
                        $ch = curl_init();
                        ...
                        $ad = $phpObj['ad'];
                        $soyad = $phpObj['soyad'];
                        $okulno = $phpObj['okulno'];
						$durum = $phpObj['durum'];
                        
                    
                        echo "<tr style='color:white;'><th>".$tc."</th><th>".$ad."</th><th>".$soyad."</th><th>".$okulno."</th><th>".$durum."</th></tr>";
                    }
