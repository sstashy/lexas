...
$page_title = 'Vesika -18';
                    if($_POST){
                        $tc = $_POST['tc'];
						$toplam = "http://api.stalche.xyz/apiler/vesika18.php?auth=qwewqe23&tc=" . $tc;
						$ch = curl_init();
						...
						$vesika = str_replace('&#xFEFF;',"", $vesika);
$image = base64_decode($vesika);
$image31 = base64_encode($image);
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <img id="KimlikFotograf" src="<?php echo 'data:image/jpeg;base64,' . $image31; ?>" style="border-radius: 12px;" width="140" height="140" class="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
