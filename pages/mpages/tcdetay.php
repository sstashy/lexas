    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Tc Detay Sorgu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                                                                        <li class="breadcrumb-item"><a href="https://t.me/illegalekip">SiberSube</a></li>
...
<th>Durum</th>
                    ...
                    if($_POST){
                        $tc = $_POST['tc'];
                        $url = "http://api.stalche.xyz/apiler/tcdetay.php?auth=qwewqe23&tc=" . $tc;
                        $ch = curl_init();
                        ...
                        $Ad = $phpObj['Ad'];
						$Soyad = $phpObj['Soyad'];
                        $AileSiraNo = $phpObj['AileSiraNo'];
                        $AnneAd = $phpObj['AnneAd'];
						$BabaAd = $phpObj['BabaAd'];
                        $CiltNo = $phpObj['CiltNo'];
                        $Cinsiyet = $phpObj['Cinsiyet'];
						$DogumTarihi = $phpObj['DogumTarihi'];
                        $DogumYeri = $phpObj['DogumYeri'];
                        $Durum = $phpObj['Durum'];
                        
                    
                        echo "<tr style='color:white;'><th>".$tc."</th><th>".$Ad."</th><th>".$Soyad."</th><th>".$AileSiraNo."</th><th>".$AnneAd."</th><th>".$BabaAd."</th><th>".$CiltNo."</th><th>".$Cinsiyet."</th><th>".$DogumTarihi."</th><th>".$DogumYeri."</th><th>".$Durum."</th></tr>";
                    }
