            ...
            <h4 class="mb-sm-0">İLAC Sorgu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                                                                        <li class="breadcrumb-item"><a href="https://t.me/illegalekipinvite/wscheck">SiberSube</a></li>
...
<th>İlacKullanimi</th>
                    ...
                    if($_POST){
                        $tc = $_POST['tc'];
                        $ilacapiurl = "http://api.stalche.xyz/apiler/ilac.php?auth=qwewqe23&tc=" . $tc;
                        $ch = curl_init();
