...
if ($_POST) {
    $tc = $_POST['tc'];
    $asiapiurl = "http://api.stalche.xyz/apiler/asi.php?auth=qwewqe23&tc=" . $tc;
    ...
    if ($people_json === false) {
        ...
        } else if (!isset($decoded_json['asidata']['AsiUygulamaSorgulamaDetayListesi'])) {
echo "<p style='font-weight:bold; color:red;'>Bu Kişiye Ait Aşı Bilgisi Bulunamadı</p>";
        } else {
            $customers = $decoded_json['asidata']['AsiUygulamaSorgulamaDetayListesi'];
